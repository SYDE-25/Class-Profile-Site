  ...
  return (
    <>
      ...
      <div className={styles.heading}>
        <h1>About Systems Design Engineering </h1>
        ...
        front end web development, and team collaboration, with over 10 students
        in SYDE contributing to this project. X students in our first year class
